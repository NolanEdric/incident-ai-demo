...
var Util = (function(window, undefined) {
    ...
    var fontLoadTimeout = 60000; // 5 seconds
...
//             return color;
    ...
    var loadFonts = function(webFontURLs, dispatcher) {
      ...
      webFontURLs = webFontURLs || [
        'brat/js/static/fonts/Astloch-Bold.ttf',
        'brat/js/static/fonts/PT_Sans-Caption-Web-Regular.ttf',
        'brat/js/static/fonts/Liberation_Sans-Regular.ttf'
      ];
